...
const PAGE_TITLE = 'Validation Dashboard — Onboarding Guide';
...
async function main() {
  ...
  const mdPath = path.join(__dirname, '../33_VALIDATION_DASHBOARD_ONBOARDING_GUIDE.md');
  ...
  <ac:rich-text-body>
    <p><strong>Dashboard:</strong> Validation | <strong>Version:</strong> 25.4.5.3 | <strong>Data As Of:</strong> 3/31/2026 | <strong>Last Updated:</strong> 4/3/2026</p>
    <p><strong>Workspace:</strong> 10966-MPCU-prod-loan-analytics-data-validation</p>
    <p>This guide covers all 9 pages of the Validation Dashboard used during client onboarding. Each section includes the page purpose, available filters, table definitions, and a screenshot placeholder.</p>
  </ac:rich-text-body>
</ac:structured-macro>
...
<hr />
<p style="color: #666; font-size: 12px;"><em>Source: 33_VALIDATION_DASHBOARD_ONBOARDING_GUIDE.md — Maintained by Sprintendo Loan Analytics Team.</em></p>
`;
