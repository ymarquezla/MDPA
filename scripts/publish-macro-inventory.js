// Publish MDPA Macro Inventory to Confluence
...
const PAGE_TITLE = 'Macro Inventory'; // MUST match success criterion exactly
...
async function main() {
  ...
  console.log('Creating MDPA Macro Inventory page...');
  if (isDryRun) {
    console.log('[DRY RUN MODE — no API calls will be made]');
  }

  // Read source markdown
  const mdPath = path.join(__dirname, '../MACRO_INVENTORY.md');
  ...
  <ac:rich-text-body>
    <p><strong>Document Status:</strong> Phase 6 — Macro Inventory (Final)</p>
    <p><strong>Source File:</strong> MACRO_INVENTORY.md in MDPA repository</p>
...
<hr />
<p style="color: #666; font-size: 12px;"><em>Source: MACRO_INVENTORY.md — MDPA Macro Inventory Phase 6. Maintained by Rise Analytics Implementation Team.</em></p>
`;
